...
def main(args=None):
        ...
        dataloader_train = DataLoader(dataset_train, num_workers=6, collate_fn=collater, batch_sampler=sampler)
        ...
        torch.save(retinanet, 'saved/model_final.pt'.format(epoch_num))
